...
class _NewHomestayScreenState extends State<NewHomestayScreen> {
  ...
  final TextEditingController _hspriceEditingController =
      TextEditingController();
  final TextEditingController _hsqtyEditingController = 
      TextEditingController();
  ...
  File? _image;
  var pathAsset = "assets/images/1camera.png";
                ...
                child: Column(children: [
                  ...
                  Row(children: [
                    Flexible(
                        ...
                        child: CheckboxListTile(
                          title: const Text("Registered Homestay?"), //    <-- label
                          value: _isChecked,
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      child: const Text('Submit Homestay'),
                      onPressed: () => {
                        _newProductDialog(),
                      },
                    ),
  ...
  void insertHomestay() {
    ...
    http.post(Uri.parse("${ServerConfig.SERVER}/php/insert_homestayraya.php"), body: {
